...
def test_RL():
    cpu = PicoBlaze()
    #         "100000xxxx00000010"
    program = "100000000000000010"  # RL sx
...
def test_RR():
    cpu = PicoBlaze()
    #         "100000xxxx00001100"
    program = "100000000000001100"  # RR sx
    value_register_sx = 1
    number_register_sx = 0
    cpu._PicoBlaze__sixteen_byte_wide_registers[number_register_sx] = value_register_sx
    cpu.run(program)
